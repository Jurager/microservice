...
/**
 * A small signed claim binding a service name to its public key. Not X.509 —
 * deliberately simpler, since nothing outside this package ever needs to read it.
 */
final class Certificate
{
    ...
    public static function issue(string $service, string $publicKey, OpenSSLAsymmetricKey $caPrivateKey): self
    {
    ...
    /** Whether this certificate was signed by the given CA. */
